...
@interface MyFriendMessListVC ()<MessageCellDelegate,MessageListRequestCellDelegate,UIActionSheetDelegate,
...
@implementation MyFriendMessListVC
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(getMessListSucceed:) name:USER_MYHOMEPAGE_MYFRIEND_SUCCEED object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(getMessListFail:) name:USER_MYHOMEPAGE_MYFRIEND_FAIL object:nil];
...
-(void)setTableViewMess{
    ...
    _page = 1;
    [self getMessageData];
    __weak MyFriendMessListVC *blockSelf = self;
...
- (void)getMessageData{
    ...
    [net getDataWithStyle:NetStylePostFriendsMessage andParam:params];
