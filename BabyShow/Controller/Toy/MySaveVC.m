...
-(void)setAllWebView{
    ...
    NSString *urlString = [NSString stringWithFormat:@"https://api.meimei.yihaoss.top/H5/toy_count/collection.html?login_user_id=%@",LOGIN_USER_ID];
