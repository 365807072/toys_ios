//
//  WorthBuyDetailListViewController.h
//  BabyShow
//
...
@interface WorthBuyDetailListViewController : UIViewController<UITableViewDelegate,UITableViewDataSource,WorthBuyCellDelegate,MWPhotoBrowserDelegate>
{
...
@property(nonatomic,assign)NSInteger buy_list;
