...
@interface ToyThridStyleCell : UITableViewCell
...
@property(nonatomic,strong)UIButton *toyView2;
...
@property(nonatomic,strong)UIButton *toyView3;
...
@property(nonatomic,strong)UIButton *toyView4;
@property(nonatomic,strong)UIImageView *storeImg4;
@property(nonatomic,strong)WMYLabel *toyNameLabel4;
@property(nonatomic,strong)UILabel *priceShow4;
