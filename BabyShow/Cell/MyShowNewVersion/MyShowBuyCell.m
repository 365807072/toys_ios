...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
     self.contentView.backgroundColor = [BBSColor hexStringToColor:@"e6e6e6"];
        ...
        _priceBackView1 = [[UIImageView alloc]initWithFrame:CGRectMake(0, 123,153 , 30)];
        _priceBackView1.image = [UIImage imageNamed:@"img_myshownew_backview"];
        [_storeImg1 addSubview:_priceBackView1];
        _priceBackView2 = [[UIImageView alloc]initWithFrame:CGRectMake(0, 123,153 , 30)];
        ...
        _priceMarkt1 = [[UILabel alloc]initWithFrame:CGRectMake(153-80, _priceShow1.frame.origin.y, 40, 19)];
        _priceMarkt1.text = @"原价：";
        ...
        _priceMarkD1 = [[DeleteLineLabel alloc]initWithFrame:CGRectMake(_priceMarkt1.frame.origin.x+30, _priceMarkt1.frame.origin.y, 45, 19)];
        ...
        _priceMarkt2 = [[UILabel alloc]initWithFrame:CGRectMake(153-80, _priceShow2.frame.origin.y,40, 19)];
        _priceMarkt2.text = @"原价：";
        ...
        _priceMarkD2 = [[DeleteLineLabel alloc]initWithFrame:CGRectMake(_priceMarkt2.frame.origin.x+30, _priceMarkt2.frame.origin.y, 45, 19)];
