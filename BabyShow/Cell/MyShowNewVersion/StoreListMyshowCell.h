...
@interface StoreListMyshowCell : UITableViewCell
...
@property(nonatomic,strong)UILabel *storeNameLabel1;
...
@property(nonatomic,strong)UILabel *storeNameLabel2;
