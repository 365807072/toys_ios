...
//
//  MyShowNewPickedTitleNotTodayCell.m
//  BabyShow
//
...
@implementation MyShowNewPickedTitleNotTodayCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
       ...
       // self.levelImageView.backgroundColor = [UIColor grayColor];
...
-(void)OnClick:(btnWithIndexPath *) btn{
    if ([self.delegate respondsToSelector:@selector(PickedTitleNotTodayGotoTheUserPage:)]) {
        [self.delegate PickedTitleNotTodayGotoTheUserPage:btn];
    }
}
