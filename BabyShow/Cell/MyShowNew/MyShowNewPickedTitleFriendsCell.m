//
//  MyShowNewPickedTitleFriendsCell.m
//  BabyShow
//
...
@implementation MyShowNewPickedTitleFriendsCell
...
-(void)OnClick:(btnWithIndexPath *) btn{
    if ([self.delegate respondsToSelector:@selector(PickedTitleFriendsCellGotoTheUserPage:)]) {
        [self.delegate PickedTitleFriendsCellGotoTheUserPage:btn];
    }
}
