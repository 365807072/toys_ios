...
@synthesize downOriginImage = _downOriginImage;
@synthesize downThumbImage = _downThumbImage;
@synthesize img_info = _img_info;
...
- (id)initWithImage:(UIImage *)image info:(NSDictionary *)img_info{
	if ((self = [super init])) {
		_image = image;
...
- (id)initWithURL:(NSURL *)url info:(NSDictionary *)img_info {
	if ((self = [super init])) {
		_photoURL = [url copy];
        _img_info = [img_info copy];
	}
	return self;
}
...
//下载的原始图
-(UIImage *)downOriginImage{
    return _downOriginImage;
}
//下载的原图
-(UIImage *)downThumbImage{
    return _downThumbImage;
}
-(void)setImg_info:(NSDictionary *)img_info{
    _img_info = img_info;
}
